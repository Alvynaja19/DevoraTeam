<div class="relative" x-data="{
    ...
    <button
        ...
        type="button"
    >
        <span class="mr-3 overflow-hidden rounded-full h-11 w-11 bg-gradient-to-br from-green-500 to-green-700 flex items-center justify-center text-white font-bold text-sm">
