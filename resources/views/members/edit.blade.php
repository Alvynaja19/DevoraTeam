            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div class="sm:col-span-2">
                    ...
                    <input type="text" name="nama" id="nama" value="{{ old('nama', $member->nama) }}" required
                           class="w-full px-4 py-2.5 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-400 transition-all @error('nama') border-red-300 @enderror">
                ...
                <div>
                    ...
                    <input type="text" name="nis" id="nis" value="{{ old('nis', $member->nis) }}" required
                           class="w-full px-4 py-2.5 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-400 transition-all @error('nis') border-red-300 @enderror">
                ...
                <div>
                    ...
                    <input type="text" name="kelas" id="kelas" value="{{ old('kelas', $member->kelas) }}" required
                           class="w-full px-4 py-2.5 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-400 transition-all @error('kelas') border-red-300 @enderror">
                ...
                <div>
                    ...
                    <input type="text" name="telepon" id="telepon" value="{{ old('telepon', $member->telepon) }}"
                           class="w-full px-4 py-2.5 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-400 transition-all">
                </div>
            </div>
