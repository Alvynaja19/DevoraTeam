...
<div class="space-y-6">
    <div class="flex flex-col sm:flex-row gap-4 justify-between">
        ...
        <a href="{{ route('members.create') }}" class="inline-flex items-center gap-2 px-4 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium rounded-xl shadow-sm transition-all hover:shadow-md">
