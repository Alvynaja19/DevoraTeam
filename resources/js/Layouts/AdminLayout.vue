<template>
  <div class="min-h-screen flex" style="background:#f8fafc">
    ...
    <aside class="sidebar">
      ...
      <div class="sidebar-logo">
        <div class="flex items-center gap-3">
          ...
          <div>
            <div class="text-white font-bold text-base leading-none">Devora</div>
      ...
      <nav class="sidebar-nav">
        ...
        <NavItem :href="route('sirkulasi.peminjaman')" :active="isActive('sirkulasi')">
    ...
    <div class="main-content">
      ...
      <!-- Flash -->
      <div v-if="$page.props.flash?.success" class="mx-6 mt-4 p-3 rounded-xl text-sm font-medium flex items-center gap-2 fade-in" style="background:#f0fdf4;color:#16a34a;border:1px solid #bbf7d0">
      ...
      <div v-if="$page.props.flash?.error" class="mx-6 mt-4 p-3 rounded-xl text-sm font-medium flex items-center gap-2 fade-in" style="background:#fef2f2;color:#dc2626;border:1px solid #fecaca">
        <svg width="16" height="16" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 1 0 0-16 8 8 0 0 0 0 16ZM8.28 7.22a.75.75 0 0 0-1.06 1.06L8.94 10l-1.72 1.72a.75.75 0 1 0 1.06 1.06L10 11.06l1.72 1.72a.75.75 0 1 0 1.06-1.06L11.06 10l1.72-1.72a.75.75 0 0 0-1.06-1.06L10 8.94 8.28 7.22Z" clip-rule="evenodd"/></svg>
